...
insert into actions_car_parts(actions_id, car_parts_id) values( 1, 2 );
insert into actions_car_parts(actions_id, car_parts_id) values( 1, 3 );
insert into actions_car_parts(actions_id, car_parts_id) values( 2, 4 );
insert into actions_car_parts(actions_id, car_parts_id) values( 2, 5 );
insert into actions_car_parts(actions_id, car_parts_id) values( 2, 6 );
insert into actions_car_parts(actions_id, car_parts_id) values( 2, 7 );
insert into actions_car_parts(actions_id, car_parts_id) values( 3, 8 );
insert into actions_car_parts(actions_id, car_parts_id) values( 3, 9 );
...
insert into tickets(date, price, car_license_plate ) values( '2024-08-08', 588.75, '96-ZN-ZX' );
...
insert into invoices( date, vat_percentage, price, vat, total, ticket_id, customer_id ) values( '2024-08-09', 21.00, 588.75, 123.64, 712.39, 1 ,1 );